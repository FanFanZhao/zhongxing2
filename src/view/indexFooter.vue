              ...
              <img class="logos" src="../assets/images/cooper04.png" />
               <img class="logos" src="../assets/images/cooper05.png" />
                ...
                <ul class="mr120 ft12 foot_ul">
                    ...
                    <li class="mb15">
                        <router-link  :to="{path:''}" class="mr15" tag="span">{{$t('footer.legalTrade')}}</router-link>
                     ...
                     <li class="mb15">
                        ...
                        <router-link v-else :to="{path:''}" class="mr15" tag="span">{{$t('header.c2c')}}</router-link>
                        <router-link :to="{path:''}" tag="span">{{$t('header.candy')}}</router-link>
                    </li>
                     <li class="mb15">
                ...
                <ul class="mr120 ft12 foot_ul">
                    ...
                    <li class="mb15">
                        <router-link :to="{path:'/'}" class="mr15" tag="span">BANKEX</router-link>
                        <router-link :to="{path:'/components/login'}" tag="span">{{$t('footer.join')}}</router-link>
                    </li>
                     <li class="mb15">
                        <router-link :to="{path:''}" class="mr15" tag="span">{{$t('footer.connect')}}</router-link>
                ...
                <ul class="ft12 foot_ul">
                    ...
                    <li class="mb15">
                        <router-link :to="{path:''}" class="mr15" tag="span">{{$t('footer.xieyi')}}</router-link>
                        <router-link :to="{path:'/aggrement'}" tag="span">{{$t('footer.yinsi')}}</router-link>
                    </li>
                     <li class="mb15">
                        <router-link :to="{path:''}" class="mr15" tag="span">{{$t('footer.legal')}}</router-link>
                        <router-link :to="{path:''}" tag="span">{{$t('footer.feilv')}}</router-link>
                    </li>
